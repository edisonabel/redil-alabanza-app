...
repertorio = replaceExact(
  ...
  `  const feedbackMount = document.getElementById('ensayo-global-mount');\n  if (feedbackMount) {\n   feedbackMount.innerHTML = \\`\n    <div class="custom-setlist-navigation-feedback" role="status" aria-live="polite">\n     <span class="custom-setlist-navigation-spinner" aria-hidden="true"></span>\n     <strong>Abriendo modo ensayo...</strong>\n    </div>\n   \\`;\n  }\n\n  await new Promise<void>((resolve) => {\n   requestAnimationFrame(() => requestAnimationFrame(() => resolve()));\n  });\n  window.location.assign(url);`,
